...
function mulaMajlis() {
    ...
    setTimeout(() => {
        ...
        setTimeout(() => {
            ...
            // Ensure the shared background element is visible and using the
            // correct image (we moved the background to #mainBackground in CSS)
            const mb = document.getElementById('mainBackground');
            if (mb) mb.style.backgroundImage = "url('img/bg2cats.png')";
